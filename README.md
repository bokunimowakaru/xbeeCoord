# xbeeCoord for Raspberry Pi / Arduino / Cygwin for Windows / H8 3694F
...
- examples_pi ：Raspberry Pi用サンプル  
        - ZB Coord API for XBee の Raspberry Pi 用マニュアル  
          https://bokunimo.net/bokunimowakaru/download/xbee/README_raspi.pdf  
